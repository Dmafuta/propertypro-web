        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CurrentEntranceId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Parcels_users_LoggedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnitRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnitRequests_Units_UnitId",
                        column: x => x.UnitId,
                        principalSchema: "public",
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UnitRequests_users_ResidentId",
                        column: x => x.ResidentId,
                        principalSchema: "public",
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UnitRequests_users_ReviewedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VehicleTags_users_IssuedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnitRequests_ResidentId",
                schema: "public",
                table: "UnitRequests",
                column: "ResidentId");

            migrationBuilder.CreateIndex(
                name: "IX_UnitRequests_ReviewedById",
                schema: "public",
                table: "UnitRequests",
                column: "ReviewedById");

            migrationBuilder.CreateIndex(
                name: "IX_UnitRequests_UnitId",
                schema: "public",
                table: "UnitRequests",
                column: "UnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleTags_IssuedById",
                schema: "public",
                table: "VehicleTags",
                column: "IssuedById");

            migrationBuilder.CreateIndex(
                name: "IX_VehicleTags_VehicleId",
                schema: "public",
                table: "VehicleTags",
                column: "VehicleId",
                unique: true);
